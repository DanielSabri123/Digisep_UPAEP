                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-xs-12 col-sm-6 col-md-6">
                                                <div class="form-material form-material-primary input-group floating" id="DivTxtNombreInstitucionIn">
                                                    ...
                                                    <label for="txtNombreOficial"  data-toggle="popover" title="Nombre oficial" data-placement="right" data-content="El nombre oficial aparecerá en documentos oficiales, por lo que deberá ingresar el nombre completo" data-original-title="Right Popover"><span class="text-danger ">▪</span> Nombre oficial</label>
                                                    <span class="input-group-addon "><i class="fa fa-font"></i></span>
                                                </div>
                                            </div>
                                        </div>
