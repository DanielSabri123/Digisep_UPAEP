...
<html class="no-focus" lang="es">
    ...
    <body style="overflow: hidden;">
                    ...
                    <div id="fullContent" class="push-20-t">
                                            ...
                                            <div class="col-lg-10 col-xs-12" id="DivLstCarreras">
                                                ...
                                                <div class="input-group" style="display: -webkit-box !important">
                                                    ...
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-primary btn-sm" type="button" id="btnFiltrarMaterias" style="margin-top: 3px;"><i class="fa fa-search"></i></button>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xs-12 push-10-t">
                            <div class="pull-right">
                                <button class="btn btn-danger btn-sm btn-rounded" id="btn-cargar-servicio"><i class="fa fa-cloud-download"></i> Descargar Asignaturas</button>
                        ...
                        <div style="display:none;">
                            <form class="form-horizontal" id="FormCarrera" name="FormCarrera">
                                <input style="display: none;" type="text" id="txtBandera" name="txtBandera" value="">
                                <div class="form-group">
                                    <input style="display: none;" class="form-control" type="file" id="fileCarrera" name="fileCarrera" title="Cargar Calificaciones">
                                </div>
                                <div class="form-group">
                                    <button class="btnAccionesCarrera" style="display:none;" type="submit" id="importarArchivoCarreras" name="importarArchivoCarreras" onclick="$('#txtBandera').val('excel');"></button>
                                </div>
                            </form>
                        </div>
        ...
        <div class="modal fade" id="modal-upaep-carreras" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false">
            <div class="modal-dialog modal-dialog-popin mymodal nomini">
                <div class="modal-content" id="modal-upaep-carreras-draggable" >
                    <div class="block block-themed block-transparent remove-margin-b">
                        ...
                        <div class="block-content" style="overflow: inherit;">
                            ...
                            <div class="row">
                                <div class="col-xs-12 push-5-t">
                                    <div class="alert alert-warning">
                                        <p>Las carreras que ya fueron importadas se actualizarán.</p>
                                        <p>Los documentos generados se verán afectados por dichos cambios.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-10 col-xs-12" id="div-lst-carreras">
                                    <div class="form-material form-material-primary" id="div-lst-carreras-in">
                                        <select class="form-control" id="lst-carrera-service" name="lst-carrera-service">
                                        </select>
                                        <label for="lst-carrera-service"> Selecciona una Carrera</label>
                                    </div>
                                </div>
        ...
        <script src="../assets/js/plugins/Validations/ValidacionesTECarreras.js"></script>
        <script src="../assets/js/plugins/service/download-asignaturas.js"></script>
        ...
        <input id="txtModulo" name="txtModulo" value="Carreras" style="display: none" disabled="disabled">
    </body>
</html>