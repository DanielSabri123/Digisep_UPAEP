...
<html class="no-focus" lang="es">
    <head>
        ...
        <title>Digi-SEP - Calificaciones</title>
    ...
    <body style="overflow:hidden;">
                    ...
                    <div id="fullContent" class="push-20-t">
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div id="filtrosTabla" class="panel">
                                        <div class="panel-body">
                                            <div class="col-lg-8 col-xs-12" id="DivLstCarreras">
                                                <div class="input-group">
                                                    <div class="form-material form-material-primary" id="DivLstCarrerasIn">
                                                        <select class="form-control" id="lstAlumnos" name="lstAlumnos">
                                                        </select>
                                                        <label for="lstAlumnos"> Alumnos</label>
                                                    </div>
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-primary btn-sm push-5-t" type="button" id="btnFiltrarCalificaciones"><i class="fa fa-search"></i></button>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xs-12 push-10-t">
                            <div class="pull-right">
                                <button class="btn btn-danger btn-sm btn-rounded" id="btn-cargar-servicio"><i class="fa fa-cloud-download"></i> Descargar Calificaciones</button>
                        ...
                        <div style="display:none;">
                            <form class="form-horizontal" id="FormCalificaciones" name="FormCalificaciones">
                                <input style="display: none;" type="text" id="txtBandera" name="txtBandera" value="">
                                <div class="form-group">
                                    <input style="display: none;" class="form-control" type="file" id="fileCalificaciones" name="fileCalificaciones" title="Cargar Calificaciones">
                                </div>
                                <div class="form-group">
                                    <button class="btnAccionesCalificaciones" style="display:none;" type="submit" id="importarArchivoCalif" name="importarArchivoCalif" onclick="$('#txtBandera').val('excel');"></button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="block">
                            <div class="block-content">
                                <div id="DivTblCalificaciones">
                                    <table class="table table-bordered table-condensed table-striped js-dataTable-full-pagination-Fixed" style="width:100%;"  id="tblCalificaciones">
        ...
        <script src="../assets/js/plugins/Validations/ValidacionesTECalificaciones.js"></script>
        <script src="../assets/js/plugins/service/download-calificaciones.js" type="text/javascript"></script>
        ...
        <input id="txtModulo" name="txtModulo" value="Calificaciones" style="display: none" disabled="disabled">
    </body>
</html>