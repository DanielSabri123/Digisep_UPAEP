<%-- 
    Document   : Reportes
    Created on : 16-may-2022, 17:12:02
    Author     : BSorcia
--%>
...
<html class="no-focus" lang="es">
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-lg-8 col-md-7 col-sm-12">
                                            ...
                                            <div class="col-lg-6 col-xs-6 col-md-6 push-15-t max-width">
                                            ...
                                            <div class="col-lg-3 col-xs-3 col-md-6 push-15-t max-width" data-toggle="popover" title="Información Eliminada" data-placement="right" data-content="Al marcar esta opción se consultará la información de la bitácora de movimientos." data-original-title="Right Popover">
                                                <label class="css-input css-checkbox css-checkbox-primary">
                                                    <input type="checkbox" id="eliminados"><span></span> Bitácora Eliminados.
                                                </label>
                                            </div>
                                            <div class="col-xs-3 col-lg-3 col-md-12 push-30-t max-width">
    ...
    <script src="../assets/js/plugins/Validations/ValidacionesReporteGeneral.js" type="text/javascript"></script>
    ...
    <input id="txtModulo" name="txtModulo" value="Reporte General" style="display: none" disabled="disabled">
