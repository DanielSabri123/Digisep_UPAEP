<%-- 
    Document   : CertificadosAutenticados
    Created on : 11-feb-2021, 13:35:10
...
<html>
    <head>
        ...
        <title>Digi-SEP - Certificados Autenticados</title>
    ...
    <body style='overflow:hidden;'>
                        ...
                        <div class="row push-20 bg-primary-op remove-margin" style="padding-left: 15px; padding-right: 15px;">
                            ...
                            <div class="col-lg-6 col-xs-12 col-md-6 block-content  text-center hidden-sm" style="min-height: 115px;">
                                <h1 class="h1 font-w400 text-white push-10-l">
                                    Gestión de Certificados Autenticados
                                </h1>
                            ...
                            <div class="block-header">
                                <div class="xs-12">
                                    <div class="pull-right" id="divAcciones">
                                        <button class="btn btn-primary btn-sm btn-rounded" id="btnImportarCertificadosZip"><i class="fa fa-cloud-upload"></i> Importar Certificados XML</button>
                                        <button class="btn btn-info btn-sm btn-rounded" id="btnImportarCertificadosPdf"><i class="fa fa-cloud-upload"></i> Importar Constancias PDF</button>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-bordered table-condensed table-striped js-dataTable-full-pagination-Fixed" style="width:100%;"  id="tblCertificados">
                                        <thead class="bg-primary-dark" style="color: white;">
                                            <tr>
                                                ...
                                                <th class="text-center hidden-sm hidden-xs">A. Paterno</th>
                                                <th class="text-center hidden-xs">Carrera</th>
                                                <th class="text-center" style="width: 10%">Acciones</th>
                                            </tr>
                                        </thead>
                                        <tbody id="tblBodyCertificados">
                                        </tbody>
                                    </table>
                                </div>
                            </div>
        ...
        <script src="../assets/js/plugins/Validations/ValidacionesTECertificadosAutenticados.js"></script>
        ...
        <input id="txtModulo" name="txtModulo" value="Certificados Autenticados" style="display: none" disabled="disabled">
    </body>
</html>