...
<html>
    ...
    <body style='overflow:hidden; zoom: 90%'>
                                ...
                                <div class="col-xs-12 pull-right">
                                    <div class="xs-12">
                                        <ul class="block-options">
                                            ...
                                            <li id="li-btn-up-pruebas">
                                                <button id="btn-up-pruebas" type="button" class="btn text-primary-dark li-buttons" disabled="disabled">
                                                    <i class="fa fa-cloud-upload"></i> Cargar a servicio prueba
                                                </button>
                                            </li>
                                            <li id="li-btn-up-prod">
                                                <button id="btn-up-prod" type="button" class="btn text-primary-dark li-buttons" disabled="disabled">
                                                    <i class="fa fa-mortar-board"></i> Cargar a servicio productivo
                                                </button>
                                            </li>
                                        </ul>
        ...
        <div class="modal fade" id="modal-listFirmantes" tabindex="-1" role='dialog' aria-hidden='true' style="padding-top: 80px; ">
            <div class="modal-dialog modal-dialog-popin mymodal nomini modal-sm"  style="-moz-box-shadow: 0 0 5px #888; -webkit-box-shadow: 0 0 5px #888; box-shadow: 0 0 50px #888;">
        ...
        <script src="../assets/js/plugins/Validations/ValidacionesTETitulos.js?v=1.2"></script>
