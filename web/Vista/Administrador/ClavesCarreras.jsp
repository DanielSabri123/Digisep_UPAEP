...
<html class="no-focus" lang="es">
    ...
    <body style="overflow: hidden;">
                        ...
                        <div class="block">
                            <div class="block-header">
                                <ul class="block-options">
                                    <li id="liBtnNuevo">
                                        <button id="btn-cargar-servicio" type="button" class="btn text-danger"><i class="fa fa-cloud-download"></i> Cargar Información desde Servicio</button>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12" style="display: none;">
                                    <label class="css-input css-checkbox css-checkbox-primary">
                                        <input id="descargar" type="checkbox" checked=""><span></span> Descargar Asignaturas
                                    </label>
                                </div>
        ...
        <script src="../assets/js/plugins/Validations/ValidacionesTEClavesCarrera.js?v=1.2"></script>
        <script src="../assets/js/plugins/service/download-carreras.js"></script>
