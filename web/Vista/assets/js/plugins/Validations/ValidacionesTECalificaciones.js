                ...
                $.ajax({
                    ...
                    success: function (resp) {
                        if (resp.toString().includes('success')) {
                            ...
                            swal('¡Upps!', 'La información de las calificaciones está incompleta, revise los datos del archivo', 'warning');
