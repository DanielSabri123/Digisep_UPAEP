        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                if (resp[0].includes("todos")) {
                    ...
                    if (stringStepFirst.split("¬")[0].includes("1") || stringStepFirst.split("¬")[10].includes("1")) {
                        LoadTable();
                        ...
                        } else if (stringStepFirst.split("¬")[10].includes("0")) {
                        ...
                        if (stringStepFirst.split("¬")[13].includes("0")) {
                            $("#btnUpdateRol").remove();
                        }
                    } else {
                        $(".noPermisson").show();
