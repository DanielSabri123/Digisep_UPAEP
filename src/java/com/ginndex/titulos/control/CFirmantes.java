...
public class CFirmantes {
    ...
    public String cargarListaCargos() {
        ...
        try {
            ...
            for (TECargos c : lstCargos) {
                RESP += "<option value='" + c.getID_Cargos() + "'>" + c.getCargo() + "</option>";
            }
        } catch (SQLException ex) {
    ...
    public String insertarFirmante() {
        ...
        try {
            ...
            String pass = EncrypData.encryptData(getFirmante().getContrasenia(), EncrypData.AES_KEY_LOGIN);
