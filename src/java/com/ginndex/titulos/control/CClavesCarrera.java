...
public class CClavesCarrera {
    ...
    private String AddClaveCarrera() {
        ...
        try {
            ...
            RESP = "error|Error inesperado al realizar la inserción de la carrera: " + accion_catch(ex);
        }
        return RESP;
    }
    ...
    private String UpdateClaveCarrera() {
        ...
        c.setCalificacionMinima(request.getParameter("califMin"));
        String califMax = request.getParameter("califMax");
        c.setCalificacionMaxima(request.getParameter("califMax"));
        String califMinAprobatoria = request.getParameter("califMinAprobatoria");
        c.setCalificacionMinimaAprobatoria(request.getParameter("califMinAprobatoria"));
        ...
        try {
            String Query = "SET LANGUAGE 'español'; execute Upd_Carrera '" + usuario + "'," + ttc.getID_Carrera() + ",'" + ttc.getClaveCarrera() + "','"
                    ...
                    + ttc.getFechaExpedicionRvoe() + "','" + ttc.getGradoObtenidoM() + "','" + ttc.getGradoObtenidoF() + "'," + ttc.getId_Carrera_Excel() + "," + c.getCalificacionMinima() + "," + c.getCalificacionMaxima() + "," + c.getCalificacionMinimaAprobatoria() + ",'"
