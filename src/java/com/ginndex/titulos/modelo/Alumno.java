...
public class Alumno {
    ...
    private String fechaInicioAnt;
    private String fechaFinAnt;
    private String tipoAnt;
    private String paisAnt;
    private String estadoAnt;

    /**
     * ==========================================
     * Requerimiento nuevo, por parte de UPAEP
     * ==========================================
     * FECHINICIOANT, Fecha en formato dd/MM/yyyy del inicio antecedente estudiado 
     * FECHFINANT, Fecha en formato dd/MM/yyyy del final antecedente estudiado 
     * TIPOANT, Descripción del tipo de Antecedente "LICENCIATURA"
     * PAISANT, Pais en donde se estudio el antecedente "MEXICO" 
     * ESTADOANT, Estado en el que se estudio el antecedente "PUEBLA"
     */
    public Alumno() {
    ...
    public String getFechaInicioAnt() {
        return fechaInicioAnt;
    }

    public void setFechaInicioAnt(String fechaInicioAnt) {
        this.fechaInicioAnt = fechaInicioAnt;
    }

    public String getFechaFinAnt() {
        return fechaFinAnt;
    }

    public void setFechaFinAnt(String fechaFinAnt) {
    ...
    public String getPaisAnt() {
        return paisAnt;
    }

    public void setPaisAnt(String paisAnt) {
