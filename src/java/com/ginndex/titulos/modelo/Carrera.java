...
public class Carrera {
    ...
    private String CalificacionMaxima;
    private String CalificacionMinimaAprobatoria;
    ...
    public String getCalificacionMaxima() {
        return CalificacionMaxima;
    }

    public void setCalificacionMaxima(String CalificacionMaxima) {
        this.CalificacionMaxima = CalificacionMaxima;
    }

    public String getCalificacionMinimaAprobatoria() {
        return CalificacionMinimaAprobatoria;
    }

    public void setCalificacionMinimaAprobatoria(String CalificacionMinimaAprobatoria) {
